...
app.MapGet("/get-classes", async (TokenService tokenService, IElectrolyteClient electrolyteClient, ElectrolyteSettings electrolyteSettings, INtfyService ntfyService) =>
    {
        try
        {
